...
//        String clientId = "pBSTBEs12eGgstfobIiI"; //애플리케이션 클라이언트 아이디값";
//        String clientSecret = "dwwjvgwg_Y"; 
//		
...
//	}
    public static void main(String[] args) {
      String clientId = "pBSTBEs12eGgstfobIiI"; //애플리케이션 클라이언트 아이디값";
      String clientSecret = "dwwjvgwg_Y";  //애플리케이션 클라이언트 시크릿값";

        String key = "2yptHcu0mybL9GQI"; // https://openapi.naver.com/v1/captcha/nkey 호출로 받은 키값
        String apiURL = "https://openapi.naver.com/v1/captcha/ncaptcha.bin?key=" + key;
