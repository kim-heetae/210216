...
public class AddressBook extends JFrame {
    ...
    private void initComponents() {
		...
		// 전체조회 메뉴아이템
		menuItemSelect.setFont(font);
		menuItemSelect.setText("전체조회");
	...
	public void refreshData() {
		//이미 테이블에 보여지는 데이터가 있는경우 모두 삭제합니다.
